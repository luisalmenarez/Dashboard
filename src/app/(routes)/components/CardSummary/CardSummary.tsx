...
export const CardSummary = (props: CardSummaryProps) => {
  ...
  return (
    <section className="shadow-sm bg-background rounded-lg p-5 py-3 hover:shadow-lg transition hover:cursor-pointer">
      ...
      <article className="flex gap-4 mt-2 md:mt-4">
